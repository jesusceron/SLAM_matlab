...
gap = 2; % movement readings have a delay of about 2 seconds (204.8Hz)
...
for i_beacon=1:5
    ...
    switch i_beacon
        case 1
            ...
            sample_first_door_movement = 3800;%door_movement(1); % getting in to the room. p9:3800, p10:3200
            %sample_second_door_movement = 60300; p9
            for i_door_movement=1:size(door_movement,1)
                if door_movement(i_door_movement) > sample_first_door_movement + 20000
                    sample_second_door_movement = door_movement(i_door_movement);% P5:-1400 p10:-300 P11:-900getting out to the room
                end
            end
