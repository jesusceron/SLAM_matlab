...
gap = 410; % movement readings have a delay of about 2 seconds (204.8Hz)
...
for i_beacon=1:5
    ...
    switch i_beacon
        case 1
            ...
            sample_first_door_movement = door_movement(1); % getting in to the room
            
            for i_door_movement=1:size(door_movement,1)
                if door_movement(i_door_movement) > sample_first_door_movement + 20000
                    sample_second_door_movement = door_movement(i_door_movement);% getting out to the room
                end
            end
